<nav x-data="{ open: false }" class="bg-nav border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center">
                    <a href="{{ route('projects') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="291" height="45" viewBox="0 0 291 45" class="text-default" fill="currentColor">
                            <g fill="currentColor">
                                <g fill="currentColor">
            ...
            @auth
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <x-button button dropdown :value="Auth::user()->name"/>
                        </x-slot>
            ...
            @guest
                <div class="hidden sm:flex justify-end gap-x-4">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                        class="inline-flex items-center justify-center p-2 rounded-md text-muted hover:text-muted hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-muted transition duration-150 ease-in-out">
    ...
    <div
        :class="{'grid-rows-[1fr]': open, 'grid-rows-[0fr]': ! open}" class="sm:hidden grid transition-all ease-in duration-300">
